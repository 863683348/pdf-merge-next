...
const SITES = {
  ...
  8: { name: 'pdf-merge-next',        dir: `${WS}/pdf-merge-next`,            files: ['app/blog/page.tsx'],       slugRe: null,                         bareDomain: 'pdfmergenext.shop', mode: 'dirs', dirPattern: 'app/blog/*', listDataFile: 'src/lib/blog/posts.json', listSlugRe: /slug["']?:\s*['"]([^'"\s]+)['"]/g },
