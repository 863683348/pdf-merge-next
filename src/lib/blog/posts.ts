...
export const BLOG_POSTS: BlogPostMeta[] = [
  ...
  },
  {
    ...
    zhDesc: "合并 PDF 时\"文件不上传\"意味着什么？7 个隐私事实：没有上传就没有服务器日志、没有传输链路、没有第三方接触。以及哪些承诺其实说了等于没说。",
  },
  {
    ...
    zhDesc: "同样叫合并 PDF，架构可能完全不同。客户端工具在浏览器本地处理、文件不出设备；服务器端工具把文件上传云端。隐私、速度、离线能力的差异全讲透。",
  },
  {
    ...
    zhDesc: "PDFMergeNext 的隐私设计是怎么落地的：文件为什么不上传、本地处理的技术架构、日志策略与安全边界。",
  },
  {
    ...
    zhDesc: "离线PDF合并到底能走多远？浏览器本地处理的理论边界、实际瓶颈（内存/性能/加密 PDF/扫描件），以及哪些场景确实做不到 100% 离线。",
  },
  {
    ...
    zhDesc: "浏览器合并PDF 为什么是隐私革命：文件不离开设备、没有服务器日志、没有传输链路。WebAssembly + pdf-lib 让本地合并足够流畅。",
  },
  {
    ...
    zhDesc: "WebAssembly + pdf-lib 本地架构拆解：零网络请求如何实现、如何用 DevTools 自己验证、限制与边界。",
  },
  {
    ...
    zhDesc: "从数据链路、服务器日志到中间人攻击逐层拆解本地 vs 在线合并的安全性差异，附本地方案对比与验证方法。",
  },
  {
    ...
    zhDesc: "3 种不上传合并方案对比（浏览器/桌面/系统工具）、PDFMergeNext 完整使用步骤、隐私合规指南。",
  },
  {
    ...
    zhDesc: "三种不上传合并方法对比，附 DevTools 验证零上传教程与挑页合并技巧。Three no-upload methods compared, plus a DevTools trick to verify it yourself.",
  },
  {
    ...
    zhDesc: "全面的三工具对比——隐私、免费限制、挑页合并、水印、价格，附第三方实测数据。Honest comparison across privacy, free limits, page selection, watermarks, and pricing with third-party test data.",
  },
  {
    ...
    zhDesc: "文件不上传服务器，合同、证件、财务报表更安全。免注册、无水印、免费。",
  },
  {
    ...
    zhDesc: "评测隐私优先 PDF 工具时我们看什么：数据链路、服务器日志、上传时机、删除承诺的可验证性、以及离线能力。一套可以自己复用的评测清单。",
  },
  {
    ...
    zhDesc: "别信宣传，自己验证：打开浏览器 DevTools 的 Net 面板，五分钟看清一个 PDF 工具到底有没有把文件传上服务器。带步骤的实操指南。",
  },
  {
    ...
    zhDesc: "个人隐私 PDF 工具和企业级 SaaS 差在哪？从文件到底在谁手里、本地隐私保什么、到自托管中间路线，一篇讲清两者在隐私维度上的真实取舍。",
  },
  {
    ...
    zhDesc: "把 PDF 传上网之前，先想想数据出境这四个字。PDF 里藏着哪些敏感信息、在线工具的数据流向、GDPR 的约束，以及怎么判断一个工具是否真的本地处理。",
  },
  {
    ...
    zhDesc: "一套隐私友好的 PDF 工作流只有一条原则：文件不出本机。从合并、压缩到签署，每一步都用本地处理，你就不需要信任任何服务器的日志或保留政策。",
  },
  {
    ...
    zhDesc: "不想把 PDF 上传到云，又想干完合并、压缩、拆分这些活？这份清单列了 24 个本地优先的隐私 PDF 工具替代品：免费选项、开源选项、离线选项，以及它们各自适合谁。",
  },
  {
    ...
    zhDesc: "怎么合并PDF？一份完整步骤图解：用浏览器本地工具(PDFMergeNext)合并，文件不上传、可断网、免注册无水印。含方法对比、挑页合并与手机端操作。",
  },
  {
    ...
    zhDesc: "手机上怎么合并PDF？iOS（Safari）和 Android（Chrome）都能用浏览器本地工具完成——文件不上传、不装 App、不挑网络。含分步教程、方案对比与手机端限制。",
  },
  {
    ...
    zhDesc: "PDF 合并有 5 种常见方法：在线工具、桌面软件、命令行、浏览器插件、编程语言库。本文对比它们在隐私、成本、功能和易用性上的差异，帮你选对工具。",
    enDesc: "There are 5 common ways to merge PDFs: online tools, desktop software, command line, browser extensions, and programming libraries. This post compares them on privacy, cost, features, and ease of use to help you choose the right tool.",
  },
  {
    ...
    zhDesc: "合并多个 PDF 文件其实很简单。本文教你三步完成：选择工具、上传文件、点击合并。含隐私提醒和常见错误避免方法。",
    enDesc: "Merging multiple PDF files is simpler than you think. This post teaches you the three steps: choose a tool, upload files, and click merge. Includes privacy tips and common mistakes to avoid.",
  },
  {
    ...
    zhDesc: "掌握拖拽排序的进阶技巧：批量调整、快捷键、常见错误避免，让 PDF 合并效率翻倍。",
    enDesc: "Master drag-sort PDF pro tips: batch reordering, keyboard shortcuts, and common mistakes to avoid. Double your PDF merge efficiency.",
  },
  {
  ...
  },
  {
    ...
    tag: "Windows 技巧 · Windows Tips",
    date: "2026-08-26",
    zhTitle: "Windows 合并 PDF：免费工具指南",
    enTitle: "Merge PDF on Windows: Free Tools",
    zhDesc: "在 Windows 上合并 PDF 不需要付费软件。几个免费选项各有优势，以下是实用比较。",
    enDesc: "Merging PDFs on Windows does not require paid software. Several free options exist, each with different strengths.",
  },
  {
    slug: "merge-pdf-iphone-safari",
    tag: "iPhone 技巧 · iOS Tips",
    date: "2026-08-27",
    zhTitle: "iPhone 合并 PDF：Safari 完整教程",
    enTitle: "Merge PDF on iPhone: Safari Guide",
    zhDesc: "无需安装应用，直接在 iPhone Safari 中合并 PDF。本教程展示文件应用方法和分享表单技巧。",
    enDesc: "Merge PDFs directly in Safari on iPhone without installing any apps. This guide shows the built-in Files app method and share sheet tricks.",
  },
  {
    slug: "android-merge-pdf-chrome",
    tag: "Android 技巧 · Chrome Tips",
    date: "2026-08-28",
    zhTitle: "Android 合并 PDF：Chrome 浏览器方式",
    enTitle: "Merge PDF on Android: Chrome Browser Method",
    zhDesc: "无需安装应用，在 Android Chrome 中合并 PDF。本文展示在线工具、Google Drive 与本地方案，文件可完全不出设备。",
    enDesc: "Merge PDFs on Android without installing an app. This guide covers online tools, Google Drive, and fully local browser-based methods.",
  },
];
