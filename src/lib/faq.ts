  ...
  items: [
    {
      ...
      a: {
        zh: '不会。PDFMergeNext 完全在您的浏览器本地运行，所有解析与合并都在您的设备（端侧）完成，文件不会上传到任何服务器，我们也无法看到您的内容。非常适合合同、财务报表、身份证件等敏感文档。',
        en: 'No. PDFMergeNext runs entirely in your browser. All parsing and merging happen on your device (on-device / client-side). Files are never uploaded to any server, and we cannot see your content. Ideal for contracts, financial statements, and ID documents.',
      },
    },
    {
      id: 'no-install',
