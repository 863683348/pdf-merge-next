...
export const dict: DictMap = {
  zh: {
    ...
    // ---- 账户中心 ----
    'nav.account': '我的',
    'meta.title.account': '我的账户',
    'account.locale': 'zh',
    'account.title': '我的账户',
    'account.subtitle': '查看你的会员状态、订阅详情与当前使用上限。',
    'account.sectionUser': '账户',
    'account.sectionPlan': '会员状态',
    'account.sectionPro': 'Pro 权益',
    'account.lockedHint': '会员状态仅登录后可见。先登录即可查看你的订阅与权益。',
    'account.notLoggedIn': '你还未登录。登录后可管理订阅。',
    'account.planFree': '免费版',
    'account.planMonthly': 'Pro 月付',
    'account.planYearly': 'Pro 年付',
    'account.since': '订阅自',
    'account.limitFiles': '文件数',
    'account.limitFilesFree': '5',
    'account.limitFilesPro': '不限',
    'account.limitSingle': '单文件上限',
    'account.limitSingleFree': '100 MB',
    'account.limitSinglePro': '500 MB',
    'account.limitTotal': '总大小上限',
    'account.limitTotalFree': '200 MB',
    'account.limitTotalPro': '2 GB',
    'account.proActive': 'Pro 订阅有效',
    'account.manageSub': '管理订阅',
    'account.upgrade': '升级 Pro 解锁更多',
    'account.benefit1': '不限文件个数（免费版 5 个）',
    'account.benefit2': '单文件上限 500 MB（免费版 100 MB）',
    'account.benefit3': '总大小上限 2 GB（免费版 200 MB）',
    'account.benefit4': '按页旋转',
    'account.benefit5': '自动添加书签',
  ...
  en: {
    ...
    // ---- Account ----
    'nav.account': 'Account',
    'meta.title.account': 'My Account',
    'account.locale': 'en',
    'account.title': 'My Account',
    'account.subtitle': 'Check your membership, subscription details, and current usage limits.',
    'account.sectionUser': 'Account',
    'account.sectionPlan': 'Plan',
    'account.sectionPro': 'Pro Benefits',
    'account.lockedHint': 'Membership details are only visible after sign-in. Please sign in to view your subscription and benefits.',
    'account.notLoggedIn': 'You\'re not signed in. Sign in to manage your subscription.',
    'account.planFree': 'Free',
    'account.planMonthly': 'Pro Monthly',
    'account.planYearly': 'Pro Yearly',
    'account.since': 'Active since',
    'account.limitFiles': 'Max files',
    'account.limitFilesFree': '5',
    'account.limitFilesPro': 'Unlimited',
    'account.limitSingle': 'Single file',
    'account.limitSingleFree': '100 MB',
    'account.limitSinglePro': '500 MB',
    'account.limitTotal': 'Total size',
    'account.limitTotalFree': '200 MB',
    'account.limitTotalPro': '2 GB',
    'account.proActive': 'Pro subscription active',
    'account.manageSub': 'Manage subscription',
    'account.upgrade': 'Upgrade to Pro',
    'account.benefit1': 'Unlimited files (vs 5 on Free)',
    'account.benefit2': 'Single file up to 500 MB (vs 100 MB on Free)',
    'account.benefit3': 'Total size up to 2 GB (vs 200 MB on Free)',
    'account.benefit4': 'Rotate by page',
    'account.benefit5': 'Auto-add bookmarks',
