...
export function TopBar() {
  ...
  const segItem =
    'whitespace-nowrap rounded px-2 py-1 text-sm font-medium transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-surface';
    ...
    <header className="sticky top-0 z-30 h-topbar border-b border-line bg-surface">
      <div className="flex h-full items-center justify-between gap-3 px-4 sm:px-6">
        <div className="flex min-w-0 items-center gap-2.5">
          <Link
            href="/"
            className="whitespace-nowrap text-title-sm font-semibold tracking-tight transition-colors duration-fast hover:text-brand"
          >
            {t('app.name')}
          </Link>
          <SecureBadge className="hidden whitespace-nowrap lg:inline-flex" />
          <Link
            href="/pricing"
            className="ml-1 hidden whitespace-nowrap rounded px-2 py-1 text-sm font-medium text-fg-secondary transition-colors duration-fast hover:bg-subtle hover:text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-surface sm:inline-flex"
          >
            {t('nav.pricing')}
          </Link>
          <Link
            href="/blog"
            className="hidden whitespace-nowrap rounded px-2 py-1 text-sm font-medium text-fg-secondary transition-colors duration-fast hover:bg-subtle hover:text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-surface sm:inline-flex"
          >
            {t('nav.blog')}
          </Link>
          <Link
