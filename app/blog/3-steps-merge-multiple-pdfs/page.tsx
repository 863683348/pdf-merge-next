...
export const metadata: Metadata = {
  title: '三步合并多个 PDF：最简单的方法 / 3 Steps to Merge Multiple PDFs | PDFMergeNext',
  description:
    '合并多个 PDF 其实很简单：选工具、选文件、点合并，三步搞定。本文用本地工具演示完整流程，并提醒常见的隐私误区和错误。',
  keywords: [
    '合并多个pdf',
    'merge multiple pdfs',
    '怎么合并pdf',
  ...
  openGraph: {
    title: '三步合并多个 PDF / 3 Steps to Merge Multiple PDFs · PDFMergeNext',
...
export default function ArticlePage() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Article',
        headline: '三步合并多个 PDF：最简单的方法 / 3 Steps to Merge Multiple PDFs',
        description:
